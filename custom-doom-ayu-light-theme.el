...
;;
(def-doom-theme custom-doom-ayu-light
  "A light theme inspired by Ayu Light"

  ;; name        default   256       16
  (
   ;; common
   (common-accent   '("#cebcf3" "orange"  "orange"))
   (common-bg       '("#fafafa" "black"   "black"))
   (common-fg       '("#575f66" "grey"    "grey"))
   (common-ui       '("#ba9199" "grey"    "grey"))
   (test            '("#2ea8e6" "grey"    "grey"))
   (gay-pink        '("#f3bee2" "gay-pink" "gay-pink"))
   (soft-orange     '("#e79f7d" "soft-orange" "soft-orange"))
   ;; syntax
   ...
   (vertical-bar   (doom-lighten common-bg 0.45))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ((line-number &override) :foreground gay-pink)
   ((line-number-current-line &override) :foreground soft-orange)
